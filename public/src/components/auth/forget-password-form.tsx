...
import { useSendOTP } from '@rest/user';
...
const ForgetPasswordForm = () => {
  ...
  const { isLoading, mutate: sendOTP, serverError, setServerError } = useSendOTP()
  const {
    register,
    handleSubmit,
    formState: { errors },
