...
import { useRegister } from 'src/framework/rest/user';
        ...
        <div className="w-full md:w-1/2 lg:w-[45%] xl:w-[40%] py-6 sm:py-10 px-4 sm:px-8 md:px-6 lg:px-8 xl:px-12 rounded-md shadow-dropDown flex flex-col justify-center">
          <div className="text-center mb-6 pt-2.5">
            ...
            <div className="mt-3 mb-1 text-sm text-center sm:text-base text-body">
              ...
              <button
                type="button"
                className="text-sm font-semibold ltr:ml-1 sm:text-base text-brand hover:no-underline focus:outline-none"
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="flex ltr:ml-auto mt-[2px]" onClick={closeModal}>
                  <Link
                    href={ROUTES.PRIVACY}
