        ...
        >
          ...
          {variant === 'bottom' ? (
            <Transition.Child
              ...
              leaveTo="top-[100vh]"
            >
              <div className="w-full md:w-[500px] xl:w-auto inline-block p-0 ltr:text-left align-middle transition-all shadow-xl relative z-50 h-[75vh] overflow-hidden">
                <div className="relative h-full">
                  <button
                    onClick={onClose}
                    aria-label="Close panel"
                    className="absolute opacity-0 top-2 md:top-4 ltr:right-2 md:ltr:right-4"
                  />
                  {children}
                </div>
              </div>
            ...
            >
              <div className="relative z-50 inline-block w-full p-4 overflow-hidden align-middle transition-all transform md:w-auto md:p-6 xl:p-8 ltr:text-left">
