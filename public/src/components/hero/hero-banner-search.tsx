    ...
    >
      <label htmlFor="hero-search" className="flex flex-1 items-center py-0.5">
        <input
          ...
          className={`w-full text-sm transition-all duration-200 outline-none text-brand-dark/80 h-14 ${
            style !== 'antique'
              ? 'ltr:pl-5 md:ltr:pl-6 ltr:pr-14 md:ltr:pr-16 md:h-16 shadow-heroSearch placeholder:text-brand-dark/50 rounded-md'
              : 'ltr:pl-16 h-[70px] shadow-searchBox placeholder:text-brand-dark/30 rounded-lg'
      ...
      <button
        ...
        className={`absolute top-0 flex items-center justify-center h-full transition duration-200 ease-in-out outline-none ${
          style !== 'antique' ? 'ltr:right-0' : 'ltr:left-0 text-brand'
      ...
      {style === 'antique' && button?.text ? (
        <div className="absolute top-0 ltr:right-3 h-full py-3">
          <button
            type="submit"
            title="Search"
