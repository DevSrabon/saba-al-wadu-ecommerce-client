    ...
    <div className={cn('flex flex-col', className)}>
      ...
      <ul className="flex flex-col space-y-3 text-sm lg:text-15px">
        <li className="flex items-baseline">
          {/* <span className="ltr:mr-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
            <FacebookIcon className="w-4 2xl:w-[18px] h-4 2xl:h-[18px]" />
          </span> */}
          <Link
            href={'#'}
        ...
        <li className="flex items-baseline">
          {/* <span className="ltr:mr-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
            <TwitterIcon className="w-4 2xl:w-[18px] h-4 2xl:h-[18px]" />
          </span> */}
          <Link
            href={'#'}
            className="transition-colors duration-200 hover:text-brand-dark"
        ...
        <li className="flex items-baseline">
          {/* <span className="ltr:mr-3 relative top-0.5 lg:top-1 text-sm lg:text-base">
            <LinkedinIcon className="w-4 2xl:w-[18px] h-4 2xl:h-[18px]" />
          </span> */}
          <Link
            href={'#'}
            className="transition-colors duration-200 hover:text-brand-dark"
      ...
      >
        <span className="flex items-center absolute ltr:left-0 top-0 h-12 px-3.5 transform">
          <EmailIcon className="w-4 2xl:w-[18px] h-4 2xl:h-[18px]" />
        </span>
        <Input
          ...
          variant="solid"
          className="w-full"
          inputClassName="ltr:pl-10 2xl:px-11 h-12 rounded-md"
          {...register('email', {
        ...
        <button
          className="absolute ltr:right-0 top-0 hover:opacity-80 focus:outline-none h-12 px-3 lg:px-3.5 transform scale-90 2xl:scale-100"
