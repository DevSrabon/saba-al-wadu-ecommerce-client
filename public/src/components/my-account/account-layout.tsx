...
const accountMenu = [
  ...
  {
    slug: ROUTES.WRITE_PRODUCT_REVIEW,
    name: 'text-write-product-review',
    icon: <NoticeIcon className="w-5 md:w-[22px] h-5 md:h-[22px]" />,
  },
  {
    slug: ROUTES.QUESTIONS,
    name: 'text-questions',
    icon: <NoticeIcon className="w-5 md:w-[22px] h-5 md:h-[22px]" />,
  },
  {
      ...
      <Container>
        <div className="pt-10 2xl:pt-12 pb-12 lg:pb-14 xl:pb-16 2xl:pb-20 xl:max-w-screen-xl 2xl:max-w-[1300px] mx-auto">
          <div className="flex flex-col w-full lg:flex-row">
            ...
            <div className="hidden lg:block shrink-0 w-72 xl:w-[385px] ltr:mr-7 xl:ltr:mr-8">
