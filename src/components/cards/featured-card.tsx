  ...
  return (
    <Link href={href}>
      ...
      >
        ...
        <div className="ltr:pl-4 md:ltr:pl-5 lg:ltr:pl-4 3xl:ltr:pl-6">
          ...
          <div className="uppercase text-xs xl:text-13px font-manrope font-semibold tracking-[0.6px] flex items-center text-brand-dark text-opacity-60 transition duration-200 ease-in-out group-hover:text-opacity-100">
            {t('text-learn-more')}
            <IoCaretForward className="text-sm xl:text-base transition duration-200 ease-in-out ltr:ml-1 lg:ltr:ml-1.5 opacity-60 ltr:group-hover:ml-1.5 lg:ltr:group-hover:ml-2 " />
          </div>
        </div>
      </div>
    </Link>
