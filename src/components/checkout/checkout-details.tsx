      ...
      {data?.map((item, index) => {
        return (
          ...
          >
            ...
            >
              <span className="flex items-center justify-center font-semibold border-2 border-current rounded-full h-9 w-9 text-brand ltr:mr-3">
                {index + 1}
              </span>
            ...
            <div
              ...
              className="pb-6 ltr:pl-5 sm:ltr:pl-9 lg:ltr:pl-20 sm:ltr:pr-9 ltr:pr-5 accordion__content"
            >
              ...
              {!(data?.length - 1 === index) ? (
                <div className="ltr:text-right">
                  <Button
                    ...
                    variant="formButton"
                    className="bg-brand text-brand-light rounded text-semibold font-[14px] px-4 py-3"
                  >
                    {t('button-next-steps')}
                  </Button>
                </div>
