    ...
    >
      ...
      >
        <div className="shrink-0 mx-auto md:ltr:ml-0 lg:flex lg:items-center pb-5 pt-1.5 md:pt-4 max-w-[350px] md:max-w-[340px] lg:max-w-[485px] xl:max-w-[540px] 2xl:max-w-[680px] 3xl:ltr:pl-10">
          <div className="py-8 mb-1 text-center xl:py-10 2xl:py-16 md:ltr:text-left">
        ...
        <div className="hidden md:flex items-end ltr:pl-4 2xl:ltr:pl-0 md:max-w-[450px] lg:max-w-[660px] xl:max-w-auto ltr:-mr-10 lg:ltr:-mr-16 xl:ltr:-mr-10 3xl:ltr:mr-7">
          <Image
            src={appImage}
