...
const SearchProduct: React.FC<SearchProductProps> = ({ item }) => {
  return (
    ...
    >
      <div className="relative flex w-12 h-12 overflow-hidden rounded-md cursor-pointer shrink-0 ltr:mr-4">
        <Image
          loader={productImageLoader}
          src={item?.images[0]?.image_name! || searchProductPlaceholder}
          width={48}
          height={48}
          loading="eager"
