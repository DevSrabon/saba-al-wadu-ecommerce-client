...
const WidgetAbout: React.FC<AboutProps> = ({ social, className }) => {
  ...
  return (
    <div className={`pb-10 sm:pb-0 ${className}`}>
      <div className="flex flex-col text-center sm:ltr:text-left max-w-[300px] mx-auto sm:ltr:ml-0 pb-6 sm:pb-5">
        <Logo href={ROUTES.HOME} className="mx-auto mb-3 lg:mb-5 sm:ltr:ml-0" />
      ...
      {social && (
        <ul className="flex flex-wrap justify-center mx-auto sm:justify-start">
          {social?.map((item) => (
            <li
              className="transition hover:opacity-80 last:ltr:mr-0 md:ltr:mr-5 md:mx-0 ltr:mr-4"
