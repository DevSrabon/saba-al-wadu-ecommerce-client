  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 pb-[50px]">
        ...
        <WidgetSubscription
          className={cn(
            'pt-8 border-t col-span-full sm:col-span-1 md:col-start-4 xl:col-start-auto md:col-span-4 xl:col-span-3 xl:ltr:pl-6 sm:pt-0 sm:border-t-0 border-border-three',
            {
              '2xl:ltr:pl-7 3xl:ltr:pl-16': variant === 'default',
            }
          )}
        />
      </div>
