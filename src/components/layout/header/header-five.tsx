        ...
        <Container className="flex items-center justify-between h-16 py-3 border-b top-bar lg:h-auto border-border-base">
          <div className="relative shrink-0 lg:hidden">
            ...
            >
              ...
              <span className="hidden md:inline-flex ltr:ml-2.5">
          ...
          <div className="ltr:ml-auto md:ltr:ml-0">
          ...
          <Container className="h-20 flex justify-between items-center py-2.5">
            ...
            <div className="relative categories-header-button ltr:mr-8 shrink-0">
              <button
                ...
                onClick={handleCategoryMenu}
              >
                <FiMenu className="text-2xl ltr:mr-3" />
                {t('text-all-categories')}
              </button>
            ...
            <div className="flex items-center ltr:ml-auto shrink-0">
              <Delivery />
              <div className="flex items-center w-0 py-4 overflow-hidden transition-all duration-200 ease-in-out opacity-0 navbar-right">
                <button
                  ...
                  onClick={() => openSearch()}
                  title="Search toggle"
                  className="flex items-center justify-center w-12 h-full transition duration-200 ease-in-out outline-none ltr:mr-6 md:w-14 hover:text-heading focus:outline-none"
                >
                ...
                <div className="flex items-center shrink-0 ltr:ml-7">
                  <UserIcon className="text-brand-dark text-opacity-40" />
                  <AuthMenu
                    isAuthorized={isAuthorized}
                    href={ROUTES.ACCOUNT}
