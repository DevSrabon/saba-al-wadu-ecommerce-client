          ...
          <div className="block">
            ...
            <div className="p-5 md:p-8">
              ...
              <div className="grid grid-cols-12 bg-fill-base py-3 rounded-[3px] text-brand-dark/70 text-[12px] md:text-[14px]">
                ...
                <div className="col-span-3 text-center md:ltr:text-left">
                  Quantity
                </div>
              ...
              <div className="mt-3 ltr:text-right">
                <div className="text-black inline-flex flex-col text-[12px] md:text-[14px]">
                  <div className="pb-1 mb-2 border-b border-border-base ltr:pl-20">
                    <p className="flex justify-between mb-1">
                      <span className="ltr:mr-8">Sub total: </span>
                    ...
                    {typeof data?.discount === 'number' && (
                      <p className="flex justify-between mb-2">
                        <span className="ltr:mr-8">Discount: </span>
                        <span className="font-medium">
                    ...
                    {typeof data?.delivery_fee === 'number' && (
                      <p className="flex justify-between mb-2">
                        <span className="ltr:mr-8">Delivery Fee:</span>
                        <span className="font-medium">
                  ...
                  <p className="flex justify-between mb-2 ltr:pl-20">
                    <span className="ltr:mr-8">Total Cost:</span>
                    <span className="font-medium">
              ...
              <div className="mt-12 ltr:text-right">
                <span className="py-3 px-5 cursor-pointer inline-block text-[12px] md:text-[14px] text-black font-medium bg-white rounded border border-solid border-[#DEE5EA] ltr:mr-4 hover:bg-[#F35C5C] hover:text-white hover:border-[#F35C5C] transition-all capitalize">
                  Report order
                </span>
                <span
                  onClick={closeDrawer}
