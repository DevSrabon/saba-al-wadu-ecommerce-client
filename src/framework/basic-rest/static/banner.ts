...
export const homeTwoBannerMedium = {
  id: 1,
  title: 'Store Of Fresh Quality Meat',
  slug: '/search',
  image: {
...
export const bannerGridThree = [
  ...
  },
  {
    ...
    image: {
      ...
      desktop: {
        url: '/assets/images/banner/banner-5.webp',
        width: 597,
        height: 340,
      },
    },
...
export const refinedSixHeroBanner = [
  {
    ...
    image: {
      mobile: {
        url: '/assets/images/hero/banner-mobile-5.webp',
        width: 450,
        height: 520,
      },
      desktop: {
        url: '/assets/images/hero/memart-hero-section-banner.webp',
        width: 1840,
        height: 370,
      },
    },
  },
  {
    ...
    slug: '/products/mustard-oil-cooking-oil-organic',
    image: {
      mobile: {
        url: '/assets/images/hero/organic_mustard_oil.webp',
        width: 450,
        height: 520,
      },
      desktop: {
  ...
  {
    id: 3,
    title: 'Organic Sugarcane jaggery powder',
    slug: '/products/%E0%A6%86%E0%A6%96%E0%A7%87%E0%A6%B0-%E0%A6%97%E0%A7%81%E0%A7%9C%E0%A6%BE%E0%A6%B0-%E0%A6%97%E0%A7%81%E0%A6%81%E0%A7%9C%E0%A6%BE',
    image: {
      mobile: {
        url: '/assets/images/hero/ME_MART_banner_ sugar_cane.webp',
        width: 450,
        height: 520,
      },
      desktop: {
...
export const bannerDiscount = [
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: '/assets/images/banner/discount/banner-5.webp',
        width: 475,
        height: 250,
      },
      desktop: {
...
export const homeSixBannerMedium = {
  id: 1,
  title: 'Super Discount 70% Off',
  slug: '/search',
  image: {
...
export const homeAntiqueHeroBanner = {
  id: 1,
  title: 'banner-antique-title',
  description: 'banner-antique-description',
  searchBox: true,
  btnText: 'Search Now',
  formTips: 'banner-search-tips',
  image: {
    mobile: {
...
export const heroSevenBanner = {
  id: 1,
  title: 'Super Sale Weekend 50% Off',
  slug: '/search',
  image: {
    mobile: {
